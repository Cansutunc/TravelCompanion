...
import com.travelcompanion.TravelCompanion.model.Weather;
...
public class WeatherController {
    ...
    private List<Weather> weatherList = Arrays.asList(
            new Weather("Sunny", 75, 1000,"Rome"),
            new Weather("Cloudy", 65, 500,"İstanbul"),
            new Weather("Rainy", 55, 100,"Paris")
    );
